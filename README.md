# HALPI2 Home Assistant add-on

Home Assistant OS add-on for the HALPI2 Raspberry Pi CM5 carrier board.
Runs [halpid](https://github.com/hatlabs/HALPI2-rust-daemon), which talks to
the carrier board's RP2040 controller over I2C: power-failure shutdown,
USB port control, and status LEDs.
...
HAOS does not enable I2C by default, and the add-on cannot enable it.
Enable it before installing — see [Before you install](#before-you-install-enable-i2c-on-the-host).
